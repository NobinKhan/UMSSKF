        ...
        <div class="flex-1 px-3 bg-white divide-y space-y-1">
          <ul class="space-y-2 pb-2">
            ...
            <li>
              ...
              { page_slug == "inbox" ? 'bg-gray-100' : 'pt'}">
            ...
            <li>
              <a href="https://demo.themesberg.com/windster-pro/mailing/inbox/" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group { page_slug == "inbox" ? 'bg-gray-100' : 'pt'}">
            ...
            <li>
              <a href="users/list/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group { page_slug == "inbox" ? 'bg-gray-100' : 'pt'}">
            ...
            <li>
              <a href="e-commerce/products/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group { page_slug == "inbox" ? 'bg-gray-100' : 'pt'}">
            ...
            <li>
              <a href="authentication/sign-in/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group { page_slug == "inbox" ? 'bg-gray-100' : 'pt'}">
            ...
            <li>
              <a href="authentication/sign-up/" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group { page_slug == "inbox" ? 'bg-gray-100' : 'pt'}">
